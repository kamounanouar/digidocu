...
@if (!Auth::guest())
    <div class="wrapper">
        ...
        <header class="main-header fixed-top">
            ...
            <!-- Header Navbar -->
            <nav class="main-header navbar navbar-expand" role="navigation">
            <div class="container-fluid">
                <!-- Sidebar toggle button-->
                 <ul class="nav navbar-nav ml-auto col-md-10">
                    <li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <!-- The user image in the navbar-->
                                     <img src="/logo.png" class="user-image" alt="User Image" width="20" height="20"/>
